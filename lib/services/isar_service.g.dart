...
extension BlogQueryWhereSort on QueryBuilder<Blog, Blog, QWhere> {
  QueryBuilder<Blog, Blog, QAfterWhere> anyId() {
...
extension BlogQueryWhere on QueryBuilder<Blog, Blog, QWhereClause> {
  QueryBuilder<Blog, Blog, QAfterWhereClause> idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, Blog, QAfterWhereClause> idNotEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, Blog, QAfterWhereClause> idGreaterThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, Blog, QAfterWhereClause> idLessThan(Id id,
      {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<Blog, Blog, QAfterWhereClause> idBetween(
    Id lowerId,
    Id upperId, {
...
extension BlogQueryFilter on QueryBuilder<Blog, Blog, QFilterCondition> {
  QueryBuilder<Blog, Blog, QAfterFilterCondition> contentIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> contentIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> createdAtIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> createdAtIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'createdAt',
      ));
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> createdAtEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'createdAt',
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> createdAtGreaterThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> createdAtLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> createdAtBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> idIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'id',
      ));
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> idIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'id',
      ));
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> idEqualTo(Id? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'id',
        value: value,
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> titleIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'title',
      ));
  ...
  QueryBuilder<Blog, Blog, QAfterFilterCondition> titleIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'title',
      ));
...
extension BlogQuerySortBy on QueryBuilder<Blog, Blog, QSortBy> {
  ...
  QueryBuilder<Blog, Blog, QAfterSortBy> sortByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Blog, Blog, QAfterSortBy> sortByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension BlogQuerySortThenBy on QueryBuilder<Blog, Blog, QSortThenBy> {
  ...
  QueryBuilder<Blog, Blog, QAfterSortBy> thenByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.asc);
    });
  }

  QueryBuilder<Blog, Blog, QAfterSortBy> thenByCreatedAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'createdAt', Sort.desc);
    });
  }
...
extension BlogQueryWhereDistinct on QueryBuilder<Blog, Blog, QDistinct> {
  ...
  QueryBuilder<Blog, Blog, QDistinct> distinctByCreatedAt() {
    return QueryBuilder.apply(this, (query) {
...
extension BlogQueryProperty on QueryBuilder<Blog, Blog, QQueryProperty> {
  QueryBuilder<Blog, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Blog, DateTime?, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
