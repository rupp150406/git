...
class BlogDoneSplashScreen extends StatefulWidget {
  const BlogDoneSplashScreen({super.key});

  @override
  State<BlogDoneSplashScreen> createState() => _BlogDoneSplashScreenState();
}

class _BlogDoneSplashScreenState extends State<BlogDoneSplashScreen>
