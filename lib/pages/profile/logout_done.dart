...
class LogoutDoneSplashScreen extends StatefulWidget {
  const LogoutDoneSplashScreen({super.key});

  @override
  State<LogoutDoneSplashScreen> createState() => _LogoutDoneSplashScreenState();
}

class _LogoutDoneSplashScreenState extends State<LogoutDoneSplashScreen>
