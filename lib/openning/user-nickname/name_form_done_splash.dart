...
class NameFormDoneSplashScreen extends StatefulWidget {
  const NameFormDoneSplashScreen({super.key});

  @override
  State<NameFormDoneSplashScreen> createState() =>
      _NameFormDoneSplashScreenState();
}

class _NameFormDoneSplashScreenState extends State<NameFormDoneSplashScreen>
        ...
        child: FadeTransition(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              // Subtitle
              Text(
                'Now you can create and read available\narticles.',
                style: subtitleStyle,
                textAlign: TextAlign.center,
              ),
            ],
